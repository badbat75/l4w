...
CONFs[readline]="configure --build=x86_64-linux-gnu --host=$HOST --prefix= --with-sysroot=$TD --with-shared"
...
CFLAGSs[isl]="${CFLAGS}"
CONFs[isl]="configure --build=x86_64-linux-gnu --host=$HOST --prefix= --with-sysroot=$TD --enable-shared --with-gmp=system --with-gmp-prefix= --with-clang=no"
